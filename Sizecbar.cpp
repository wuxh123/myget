...
CSizingControlBar::CSizingControlBar()
{
    ...
    m_szHorz = CSize(100, 100);
    m_szVert = CSize(100, 100);
    m_szFloat = CSize(100, 100);
    m_bTracking = FALSE;
    m_bKeepSize = FALSE;
...
void CSizingControlBar::SetInitialDockSize (int horz,
                                            int vert, 
                                            int floating)
{
   m_szHorz  = CSize(horz, horz);
   m_szVert  = CSize(vert, vert);
   m_szFloat = CSize(floating, floating);
}
